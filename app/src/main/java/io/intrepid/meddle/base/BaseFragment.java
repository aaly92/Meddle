...
import io.intrepid.meddle.MeddleApplication;
...
public abstract class BaseFragment<T extends BaseContract.Presenter> extends Fragment implements BaseContract.View {
    ...
    protected final MeddleApplication getSkeletonApplication() {
        return (MeddleApplication) getActivity().getApplication();
    }
}
